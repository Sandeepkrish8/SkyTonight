...
import { Activity, Wind, Sun, Zap, AlertTriangle } from 'lucide-react';
      ...
      <div className="relative z-10 p-6 md:p-8 flex flex-col h-full">
        <div className="flex justify-between items-start mb-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] font-bold uppercase tracking-widest text-emerald-400">Live Forecast</span>
          </div>
        </div>

        <div className="grid grid-cols-2 gap-4 flex-1">
          {/* KP Index */}
          <div className="col-span-2 sm:col-span-1 rounded-2xl bg-black/40 backdrop-blur-md border border-emerald-500/20 p-5 flex flex-col justify-between group-hover:border-emerald-500/40 transition-colors">
            <div className="flex items-center justify-between mb-4">
              <span className="text-xs font-semibold uppercase tracking-widest text-emerald-400/80">KP Index</span>
              <AlertTriangle className="w-4 h-4 text-emerald-400/50" />
            </div>
            <div>
              ...
              <p className="text-sm text-emerald-400 font-medium">Moderate Activity</p>
            </div>
          </div>
        ...
        {/* Verdict / Forecast */}
        <div className="mt-4 p-4 rounded-xl bg-gradient-to-r from-emerald-500/10 to-[#7C5CFF]/10 border border-white/10 flex items-center gap-4 backdrop-blur-md">
